...
import { computerCourse, graphicCourse, webDevCourse } from "../public/courseInfoArr"
               ...
               <div className="courseBody">
                    ...
                    <div className="theCourse">
                        ...
                        <div className="courseAuthor">
                            <div className="authorImgContainer">
                                <div className="authorImg">
                                    <Image src={theCourse.teacherPhoto} layout="fill" alt="avatar"/>
                                </div>
                            </div>

                            <div className="authorName">
                                    {theCourse.teacherName}
                                </div>
                        </div>
                        <div className="courseImgContainer">
                            <div className="courseImg">
                                <Image src={theCourse.courseThumbnail} layout="fill" alt="web pic"/>
                            </div>
                        </div>
                        ...
                        <ul className="roadmap">
                            {theCourse.willLearn.map((e) => <li>{e}</li>)}
                        </ul>

                        <h2 className="courseRequirementsHeadline">Talablar</h2>
                        <ul className="requirements">
                        {theCourse.requirements.map((e) => <li>{e}</li>)}
                        </ul>

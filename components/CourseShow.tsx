...
type CourseShowProps = {
 ...
 const CourseShow = ({courseShowName, courseShowDuration, courseShowSub, courseShowThumb}: CourseShowProps) => {
    return (
            <CourseShowWrap>
                ...
                <h4 className="courseShowHeadline">
                    {courseShowName}
                </h4>
                <p className="courseShowSub">
                {courseShowSub}
                </p>
                </div>
            </CourseShowWrap>

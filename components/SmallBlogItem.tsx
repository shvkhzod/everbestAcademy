...
import { BlogItemProps } from "./BigBlogItem"
 ...
 const SmallBlogItem = ({blogHeadline,blogType,blogThumbnail}:BlogItemProps) => {
    ...
    return (
        <SmallBlogItemWrap>
            ...
            <div className="ssInfo">
                ...
                <p className="smallBlogItemSub">Hamma bilishi kerak bo’lgan top-5 prinsiplar mavjud...</p>
            </div>
            </div>
        </SmallBlogItemWrap>
    )
